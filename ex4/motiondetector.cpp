...
int main(int argc, char** argv){
  ...
  cv::Mat histR, histG, histB,histR_anterior, histG_anterior, histB_anterior;
  ...
  while(1){
    ...
    //compareHist compara dois histogramas. neste caso avalia a correlacao entre eles
    ...
    //se ultrapassar limite pre definido, ativa.
